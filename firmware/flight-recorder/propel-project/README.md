...
7. Wire the soft-CPU's main loop per [contracts/fpga-recorder-contract.md](../../../specs/040-camera-redo/camera-hardware-phase/contracts/fpga-recorder-contract.md).
