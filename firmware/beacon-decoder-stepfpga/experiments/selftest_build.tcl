set PROJ "selftest"; set IMPL "impl1"; set TOP "selftest"; set DEV "LCMXO2-4000HC-4MG132C"
...
if {[file exists "selftest_pins.lpf"]} {
  if {![file exists "$PROJ.lpf"] || [rf "selftest_pins.lpf"] ne [rf "$PROJ.lpf"]} { file copy -force "selftest_pins.lpf" "$PROJ.lpf" }
}
