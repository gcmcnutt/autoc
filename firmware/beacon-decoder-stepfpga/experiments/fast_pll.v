...
/* Module Version: 5.7 */
/* C:\lscc\diamond\3.14\ispfpga\bin\nt64\scuba.exe -w -n fast_pll -lang verilog -synth synplify -arch xo2c00 -type pll -fin 12 -fclkop 108 -fclkop_tol 1.0 -trimp 0 -phasep 0 -trimp_r -phase_cntl STATIC -fb_mode 1 -lock -sticky  */
/* Tue Feb 11 11:33:53 2025 */


`timescale 1 ns / 1 ps
module fast_pll (CLKI, CLKOP, LOCK)/* synthesis NGD_DRC_MASK=1 */;
    input wire CLKI;
    output wire CLKOP;
    output wire LOCK;
