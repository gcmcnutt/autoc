...
def main():
    ...
    ap.add_argument("--run-name", default="033-phase2",
                    help="Filename prefix for output PNG. Track multiple bakes.")
    ap.add_argument("--out", type=Path, default=None,
                    help="Output PNG path. Defaults to "
                         "specs/033-m1-smooth-plus-variations/<run-name>_per_axis_time_series.png.")
    args = ap.parse_args()

    if args.out is None:
        args.out = Path(f"specs/033-m1-smooth-plus-variations/{args.run_name}_per_axis_time_series.png")
