...
Usage:
    python3 plot_evolution_progress.py
        ...
        [--out specs/032-tracker-nn-enhancements/evolution_progress.png]
        [--total-gens 800]
        [--title STR]
    ...
    Default out: specs/032-tracker-nn-enhancements/evolution_progress.png
...
def main():
    ...
    p.add_argument("--out", type=Path,
                   default=Path("specs/032-tracker-nn-enhancements/evolution_progress.png"))
