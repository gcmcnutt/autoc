# 028 research — recurrent architectures + the incentive question

**Note**: Inherited verbatim from
[`specs/027-recurrent-nn/research.md`](../027-recurrent-nn/research.md).
The literature priors and architectural ladder did not change between
027 and 028; the project priors did. The "what 027 produced" delta is
captured separately in
[`specs/027-recurrent-nn/findings.md`](../027-recurrent-nn/findings.md)
— required reading before working 028. Don't rediscover 027's
outcomes.

**Purpose**: Ground the design in what's actually known about
...
**Status**: Basic research (draft from 027). 028 may iterate on §6
(open implementation questions) once the D-alone diagnostic narrows
the failure mode — see findings.md §"Plausible failure modes".
